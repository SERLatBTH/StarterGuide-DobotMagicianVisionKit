...
## SDK
The software from dobot website doesn't work since the vision kit we have is an old version. But you can download the correlated SDK from the link https://drive.google.com/file/d/10QPqfSFerxsskOFGY8iEKa8NTOmt08SA/view?usp=sharing.
