...
* Using the SDk you can get the image from the camera, and manupilate the camera parameters like explosure and focus. The software is tested in Windows 10 and it works. 
